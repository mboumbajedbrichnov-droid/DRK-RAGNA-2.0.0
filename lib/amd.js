...
const blockJid = ["" + (process.env.BLOCKJIDS || "120363320350772178@g.us"), ...(typeof global.blockJids === "string" ? global.blockJids.split(",") : [])];
    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /50931461936|50938264199|g.test(_0x5b55c3) && _0x4186a0[0] == ",";
...
Theme : ${Config.LANG}
YT: https://www.youtube.com/@DRK-TECH "MongoDb" : sqldb ? "PostegreSql" : "𝐃𝐑𝐊- 𝙎-𝙏𝞢𝞜")}
\t_VARS_
Owner: ${Config.ownername}
Sudo: ${global.sudo}
Channel : https://whatsapp.com/channel/0029Vakp0UnICVfe3I2Fe72w`;
      try {
    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "509314619365@s.whatsapp.net"
        }
      };
